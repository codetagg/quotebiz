                        ...
                        <div class="nk-sidebar-menu" data-simplebar>
                            <ul class="nk-menu">
                                ...
                                <li class="nk-menu-item has-sub">
                                    <a href="{{ url('admin/quotes') }}" class="nk-menu-link ">
                                ...
                                <li class="nk-menu-item">
                                    <a href="{{ url('admin/customers') }}" class="nk-menu-link">
                                ...
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                          <li class="nk-menu-item">
                                            <a href="{{ url('admin/serviceprovider') }}" class="nk-menu-link"><span class="nk-menu-text">Service Providers List</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="{{ url('admin/servicecategories') }}" class="nk-menu-link"><span class="nk-menu-text">Service Categories</span></a>
                                        </li>
                                    </ul><!-- .nk-menu-sub -->
                                </li><!-- .nk-menu-item -->
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <li class="nk-menu-item has-sub">
                                    <a href="{{ url('admin/emailtemplate') }}" class="nk-menu-link">
                                ...
                                <li class="nk-menu-item has-sub">
                                    <a href="{{ url('admin/paymenthistory') }}" class="nk-menu-link">
